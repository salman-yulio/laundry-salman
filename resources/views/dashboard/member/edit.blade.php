 <!-- Modal -->
 <div class="modal fade" id="staticBackdrop{{ $member->id }}" data-backdrop="static" data-keyboard="false"
     ...
     <div class="modal-dialog" role="document">
         <div class="modal-content">
             ...
             <div class="modal-body">
                 <form action="/{{ request()->segment(1) }}/member/{{ $member->id }}" method="POST"
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                             name="alamat" required autofocus value="{{ old('alamat', $member->alamat) }}">
                         @error('alamat')
                             <div class="invalid-feedback">
                                 {{ $message }}
                             </div>
                     ...
                     <div class="mb-3">
                         ...
                         <select class="form-select form-select mb-3" aria-label=".form-select example"
                             ...
                             value="{{ old('jenis_kelamin', $member->jenis_kelamin) }}">
                     ...
                     <div class="mb-3">
                         ...
                         <input type="text" class="form-control @error('telepon') is-invalid @enderror" id="telepon"
                             name="telepon" required autofocus value="{{ old('telepon', $member->telepon) }}">
                         @error('telepon')
                             <div class="invalid-feedback">
                                 {{ $message }}
                             </div>
