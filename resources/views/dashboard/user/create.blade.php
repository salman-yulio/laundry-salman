    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/{{ request()->segment(1) }}/user" method="POST" class="mb-5 text-dark"
            ...
            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select form-select form-control mb-3" aria-label=".form-select example"
                            id="role" name="role">
                            <option selected>Pilih Role</option>
                            <option name="role">admin</option>
                            <option name="role">kasir</option>
