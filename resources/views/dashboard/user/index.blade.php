                ...
                <div class="col-md-12 col-sm-12  ">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <a href="{{ route('export-user') }}" class="btn btn-success mb-2">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form method="POST" action="{{ route('import-user') }}"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button type="button" class="btn btn-warning" data-toggle="modal"
                                                        data-target="#ModalPerbaharuiData{{ $u->id }}">
                                                        Edit
                                                    </button>
                                                    @include('dashboard.user.edit')
                                                    <!-- Button trigger modal -->
                                                    <form action="/{{ request()->segment(1) }}/user/{{ $u->id }}"
                                                        method="post" class="d-inline">
                                                        @csrf
                                                        <input type="hidden" name="_method" value="DELETE">
                                                        <button class="btn btn-danger delete-user border-0">Delete</button>
                                                        &nbsp;
                                                    </form>
                                                </td>
                                            </tr>
