                        <!-- Modal -->
                        <div class="modal fade" id="staticBackdrop{{ $p->id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="/{{ request()->segment(1) }}/penggunaan/{{ $p->id }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="number"
                                                    ...
                                                    name="qty" required autofocus value="{{ old('qty', $p->qty) }}">
                                                @error('qty')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                                            ...
                                            {{-- <div class="mb-3">
                                                ...
                                                <select class="form-select form-control col-8 form-select mb-3"
                                                    ...
                                                    autofocus value="{{ old('status', $p->status) }}">
