...
<div class="row">
    <div class="col-md-6 form-group">
        <label for="" class="col-md-4 col-form-label">Tanggal Transaksi</label>
        <div class="col-md-8">
...
<div class="modal fade" id="tblPaketModal" tabindex="-1" role="dialog" aria-labelledby="tblPaketModalLabel" aria-hidden="true">
          ...
          <table id="tblPaket2" class="table">
              ...
              <tbody>
                  ...
                  <tr>
                    ...
                    <td>{{ $paket->harga }}</td>
                    <td><button class="pilihPaket btn btn-info">Pilih</button></td>
                  </tr>
                  @endforeach
              </tbody>
          </table>
  ...
  <div class="modal fade" id="tblMemberModal" tabindex="-1" aria-labelledby="tblMemberModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-dark" id="tblMemberModal">Plih Member</h5>
            ...
            <table id="tbl-member" class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><button class="pilih-member btn btn-info">Pilih</button></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
