<div class="collapse" id="formTransaksi">
    <div class="card-body">
            ...
            <div class="card-body">
                ...
                <div class="row" class="col-12">
                    ...
                    <div class="row form-group col-6">
                        ...
                        <div>
                            <input type="date" class="form-control ml-auto" id="cash_tgl2"
                    ...
                    <table id="tblTransaksi" class="table">
                        ...
                        <tfoot>
                            ...
                            <tr>
                                ...
                                <td><input type="number" value="0" id="diskon" name="diskon" class="diskon"
                            ...
                            <tr style="background:RoyalBlue;color:whitesmoke;font-weight:bold;font-size:1em">
                                ...
                                <td><input type="text" name="total" id="total" placeholder="0"
                                        class="form-control-plaintext text-white" readonly></td>
                            </tr>
                            <tr>
                                <td colspan="3" align="right">Biaya Tambahan</td>
                                <td><input type="number" name="biaya_tambahan" id="biaya_tambahan" style="width:140px"
                                        value="0"></td>
                            </tr>
                        </tfoot>
                    </table>
        ...
        {{-- modal member --}}
        <div class="modal fade" id="tblMemberModal" tabindex="-1" role="dialog" aria-labelledby="tblMemberModal"
            aria-hidden="true">
        ...
        {{-- modal paket --}}
        <div class="modal fade" id="tblPaketModal" tabindex="-1" role="dialog" aria-labelledby="tblPaketModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <table id="tbl-paket" class="table">
                            ...
                            <tbody>
                                @foreach ($paket as $paket)
                                    <tr>
                                        <td>{{ $i = isset($i) ? ++$i : ($i = 1) }}
                                            <input type="hidden" class="idPaket" name="idPaket"
                                                value="{{ $paket->id }}">
                                        </td>
