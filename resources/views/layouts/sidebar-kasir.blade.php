...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li><a href="/k/member"><i class="fa fa-users"></i> Member </a>
            </li>
            <li><a href="/k/laporan"><i class="fa fa-archive"></i> Laporan </a>
            </li>
            <li><a href="/k/transaksi"><i class="fa fa-usd"></i> Transaksi</a>
            </li>
